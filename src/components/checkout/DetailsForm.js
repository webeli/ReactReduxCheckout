    ...
    return (
        <form onSubmit={handleSubmit} className="form-horizontal">
            ...
            <div className="checkbox" style={{marginBottom:'25px'}}>
                <label><Field name="newsletter" id="newsletter" component="input" type="checkbox"/> Ja tack, jag vill ha
                    nyhetsbrev</label>
            </div>
            <div className="checkbox" style={{marginBottom:'5px'}}>
                <label style={{cursor:'default', color:'#ccc'}}><input type="checkbox" disabled/> Ange separat
            ...
            <div style={{textAlign:'center'}}>
                <div className="checkbox" style={{marginBottom:'10px', marginTop:'20px'}}>
                    <label><Field name="accept" id="accept" component="input" type="checkbox"/> Jag accepterar
                        köpvillkor</label>
                </div>
                <button className="btn btn-default btn-black" type="submit" disabled={!valid || submitting}>Skicka
                    beställning
                </button>
            </div>
        </form>
